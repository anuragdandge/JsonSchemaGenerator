...
# def on_dropdown_select(event=None):
#     """Handles dropdown selection, gets systemId, and makes the API call."""
#     selected_path = dropdown.get()
#     system_id = terminal_nodes.get(selected_path, "System ID not found.")
...
#         if response_data:
#             messagebox.showinfo("API Response", json.dumps(response_data, indent=4))
...
api_response_label = ttk.Label(window, text="API Response:")
